...
function solution(nums) {
    ...
    // 최대로 가져갈수있는 폰켓몬의 수
    maxMon = nums.length/2
    
    // 배열의 중복값(종류)를 제거하기 위한 array -> set -> array
     ...
     */
    // 위의 제한 사항이 있기에 만약 가져갈수있는 갯수보다 종류가 많다면 
    // 가져갈수 있는 갯수만큼만 answer
    // 아니라면 종류만큼 answer를 반환한다.
    
    maxMon < tmp.length ? answer = maxMon : answer = tmp.length
